...
const HowItWorks = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      iconBg:
        "bg-gradient-to-br from-blue-100 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/20",
    ...
    },
    {
      ...
      iconBg:
        "bg-gradient-to-br from-amber-100 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/20",
  ...
  return (
    <section
      className="py-24 px-4 bg-gradient-to-b from-surface to-background"
      id="how-it-works"
    >
      <div className="container mx-auto max-w-7xl">
              ...
              <div key={index} className="relative group">
                <Card className="relative h-full border border-border bg-card hover:shadow-glow transition-all duration-500 hover:-translate-y-3 overflow-hidden">
                  ...
                  <div className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${step.gradient} blur-xl`}
                    ></div>
                  </div>
                  ...
                  <CardContent className="relative p-10 flex flex-col items-center text-center z-10">
                    ...
                    <div
                      className={`absolute top-6 right-6 text-7xl font-bold bg-gradient-to-br ${step.gradient} bg-clip-text text-transparent opacity-40 group-hover:opacity-60 transition-opacity`}
                    >
                      {step.step}
                    </div>
                    ...
                    <div className="relative mb-8 transform group-hover:scale-110 transition-transform duration-500 self-center">
                      <div
                        className={`absolute inset-0 ${step.iconBg} rounded-3xl blur-lg opacity-20 group-hover:opacity-40 transition-opacity duration-500`}
                      />
                      <div
                        className={`relative w-20 h-20 rounded-3xl ${step.iconBg} flex items-center justify-center shadow-soft`}
                      >
                  ...
                  {/* Bottom accent line */}
                  <div
                    className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${step.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}
                  ></div>
                </Card>
        ...
        <div className="text-center mt-20">
          <Link to="/login">
            <Button className="group px-8 py-8 bg-gradient-primary hover:opacity-90 text-primary-foreground rounded-full font-semibold text-lg shadow-glow hover:shadow-xl transition-all duration-300 transform hover:scale-105">
