...
export default function HomeDashboard() {
    ...
    const { data: subjects, isLoading, error } = useQuery({
        ...
        queryFn: () => subjectService.getAll(token!, null, {includeGroupsSummary: true}),
        staleTime: 1000 * 60 * 5,
    });

    // Query: load material sub groups for the selected subject
    const { data: materialSubGroups, isLoading: materialSubGroupsLoading } = useQuery({
    ...
    const createMaterialSubGroupMutation = useMutation({
        mutationFn: (dto: MaterialSubGroupDTO) => materialSubGroupsService.create(dto, token!),
        ...
        switch (view) {
                            ...
                            <div className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-3xl p-8 md:p-12 border border-border">
                                <div className="text-center mb-10">
                                    ...
                                    <p className="text-lg text-text-muted max-w-2xl mx-auto">
                                        Get started by creating your first subject. Organize your study materials, flashcards, and mindmaps in one place.
                                    </p>
                                </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                                    <Card className="bg-card border border-border hover:shadow-lg transition-shadow">
                                        <CardHeader className="text-center">
                                            ...
                                            <CardTitle className="text-xl">Create Your First Subject</CardTitle>
                                        </CardHeader>
                                        <CardContent>
                                            <p className="text-text-muted mb-4 text-center">
                                                A subject is a broad category like Mathematics, Biology, or Computer Science
                                            </p>
                                            <Button 
                                    ...
                                    <Card className="bg-card border border-border hover:shadow-lg transition-shadow">
                                        <CardHeader className="text-center">
                                            ...
                                            <CardTitle className="text-xl">Organize Materials</CardTitle>
                                        </CardHeader>
                                        <CardContent>
                                            <p className="text-text-muted mb-4 text-center">
                                                Group related study materials into logical sections
                                            </p>
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-sm">Study Recordings</span>
                                                </div>
                                                <div className="flex items-center">
                    ...
                    return (
                        <div className="w-full mx-auto">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                                <div>
                                    <h2 className="text-2xl font-bold text-foreground">{currentSubject.title}</h2>
                                    <p className="text-text-muted">
                                        {materialSubGroups?.length || 0} material sub groups
                                    </p>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    <Button 
                                        variant={subjectView === "materialGroups" ? "default" : "outline"}
                                ...
                                <div className="space-y-6">
                                    {materialSubGroupsLoading && (
                                        <div className="text-center py-8">
                                            <p>Loading material sub groups...</p>
                                        </div>
                                    )}
                                    
                                    {!materialSubGroupsLoading && materialSubGroups && materialSubGroups.length === 0 && (
                                        <div className="text-center py-12">
                                            <Folder className="mx-auto h-12 w-12 text-muted-foreground mb-4" />
                                            <h3 className="text-lg font-medium mb-2">No Material Groups Yet</h3>
                                            <p className="text-text-muted mb-4">
                                                Create your first material sub group to organize your study materials
                                            </p>
                                            ...
                                            <CardHeader>
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <Badge variant="secondary" className="text-xs">
                                                        {subject.materialSubGroupsLength || 0} groups
                                                    </Badge>
                                                </div>
                                            </CardHeader>
                                        </Card>
                                    ...
                                    >
                                        <CardHeader>
                                            <div className="flex items-center justify-between">
                                                <CardTitle className="text-lg">{subject.title}</CardTitle>
                                                <Badge variant="secondary" className="text-xs">
                                                    {subject.materialSubGroups?.length || 0} groups
                                                </Badge>
                                            </div>
                                        </CardHeader>
                                        <CardContent>
            ...
            case "create":
                return (
                    <div className="max-w-md mx-auto w-full">
                        <div className="mb-6">
                            <h2 className="text-2xl font-bold">{t(keys.createSubjectTitle)}</h2>
                            <p className="text-text-muted">Create a new subject to organize your learning materials</p>
                        </div>
                        <Card>
            ...
            case "createMaterialGroup":
                return (
                    <div className="max-w-md mx-auto w-full">
                        <div className="mb-6">
                            <h2 className="text-2xl font-bold">Create Material Sub Group</h2>
                            <p className="text-text-muted">
                                Add a material sub group to organize your study materials
                            </p>
                        </div>
                        <Card>
                            <CardContent className="pt-6">
    ...
    return (
        <div className="w-full flex flex-col gap-4 h-full">
            <HomeDashboardHeader
                setView={setView}
                handleDelete={selectedSubjectId ? () => handleDelete(selectedSubjectId) : () => {}}
